...
// +kubebuilder:webhook:path=/mutate-cache-civotest-com-v1alpha1-memcached,mutating=true,failurePolicy=fail,groups=cache.civotest.com,resources=memcacheds,verbs=create;update,versions=v1alpha1,name=mmemcached.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-cache-civotest-com-v1alpha1-memcached,mutating=false,failurePolicy=fail,groups=cache.civotest.com,resources=memcacheds,versions=v1alpha1,name=vmemcached.kb.io
